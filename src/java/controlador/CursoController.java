...
public class CursoController implements Serializable {
    ...
    @EJB
    private modelo.dao.CursoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("CursoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("CursoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("CursoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class CursoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Curso) {
                ...
                return getStringKey(o.getCodcur());
            } else {
