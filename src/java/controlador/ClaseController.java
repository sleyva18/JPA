...
public class ClaseController implements Serializable {
    ...
    @EJB
    private modelo.dao.ClaseFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("ClaseCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("ClaseUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("ClaseDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class ClaseControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Clase) {
                ...
                return getStringKey(o.getCodclas());
            } else {
