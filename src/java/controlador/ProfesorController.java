...
import modelo.dao.ProfesorFacade;
...
public class ProfesorController implements Serializable {
    ...
    @EJB
    private modelo.dao.ProfesorFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("ProfesorCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("ProfesorUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("ProfesorDeleted"));
        if (!JsfUtil.isValidationFailed()) {
