...
import modelo.dao.AlumnoFacade;
...
public class AlumnoController implements Serializable {
    ...
    @EJB
    private modelo.dao.AlumnoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("AlumnoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("AlumnoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("AlumnoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
